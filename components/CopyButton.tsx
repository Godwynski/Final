...
export default function CopyButton({ text, label = 'Copy' }: { text: string, label?: string }) {
    ...
    return (
        <button
            onClick={handleCopy}
            type="button"
            className="text-xs bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-2 py-1 rounded transition-colors flex items-center gap-1"
        >
            {copied ? (
                <>
