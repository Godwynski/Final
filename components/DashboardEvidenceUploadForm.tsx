...
export default function DashboardEvidenceUploadForm({
  caseId,
  currentPhotoCount,
}: {
  caseId: string;
  ...
  const isAtLimit =
    currentPhotoCount >= CONFIG.FILE_UPLOAD.STAFF_MAX_FILES_PER_CASE;
  ...
  return (
    <div className="space-y-4">
      ...
      <UploadLimitInfo
        ...
        maxCount={CONFIG.FILE_UPLOAD.STAFF_MAX_FILES_PER_CASE}
      ...
      >
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-300">
            Images (PNG, JPG, WebP) or Documents (PDF, DOC, DOCX) - Max{" "}
            {CONFIG.FILE_UPLOAD.MAX_SIZE_MB}MB
          </p>
          {selectedFile && (
