...
export default function Navbar({ name, onToggleSidebar }: { name: string, onToggleSidebar?: () => void }) {
    return (
        <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 print:hidden">
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center ms-3">
                            ...
                            <div className="ml-3 hidden sm:block">
                                <p className="text-sm text-gray-900 dark:text-white font-medium truncate max-w-[200px]" title={name}>
                                    {name}
                                </p>
                            </div>
                        </div>
