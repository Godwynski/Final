...
export default function AmicableSettlementForm({
  caseData,
  complainants,
  respondents,
  settings,
}: AmicableSettlementFormProps) {
  return (
    <div className="max-w-[210mm] mx-auto p-8 bg-white min-h-screen text-black font-serif">
      ...
      >
        ...
        <div className="border border-black min-h-[200px] p-4 mb-8">
          <p className="whitespace-pre-wrap">
            {caseData.resolution_details?.terms ||
              "(Enter terms of settlement here...)"}
          </p>
        </div>
      ...
      >
        <div className="text-center w-1/2">
          <p className="font-bold uppercase border-t border-black pt-2 px-8 mx-8">
            Complainant(s)
          </p>
        </div>
        <div className="text-center w-1/2">
