...
export default function ReferralForm({
  ...
  return (
    <div className="max-w-[210mm] mx-auto bg-white p-8 min-h-screen text-black font-serif relative">
      ...
      <div
        className="space-y-6 text-justify leading-relaxed outline-none"
        contentEditable
        suppressContentEditableWarning
      >
        <p>
          Respectfully indorsed to the{" "}
          <span className="font-bold underline">{agency}</span> the herein
          complaint of{" "}
        ...
        <p className="indent-8">
          This Barangay has conducted the necessary proceedings. However, it was
          determined that:
        </p>
        ...
        <p className="indent-8">
          Therefore, this case is hereby referred to your good office for
          appropriate action.
        </p>

        <p className="indent-8">
          Attached herewith are the copies of the complaint and other related
          documents.
        </p>
      </div>
