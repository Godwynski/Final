...
export default function CertificateToFileActionForm({
  caseData,
  complainants,
  respondents,
  settings,
}: CertificateToFileActionFormProps) {
  return (
    <div className="max-w-[210mm] mx-auto p-8 bg-white min-h-screen text-black font-serif">
      ...
      >
        <p className="mb-4 text-justify indent-8 leading-relaxed">
          This is to certify that a complaint for{" "}
          <span className="font-bold">{caseData.incident_type}</span> was filed
          by the complainant(s) against the respondent(s) in this office.
        </p>
        <p className="mb-4 text-justify indent-8 leading-relaxed">
          That there has been a personal confrontation between the parties
          before the Punong Barangay/Pangkat Tagapagkasundo but mediation failed
          and/or no settlement was reached.
        </p>
