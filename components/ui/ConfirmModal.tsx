...
export default function ConfirmModal({
    ...
    const colors = {
        danger: {
            ...
            button: 'bg-red-600 hover:bg-red-800 focus:ring-red-300 dark:focus:ring-red-800'
        },
        warning: {
            icon: 'text-yellow-500 dark:text-yellow-400',
            button: 'bg-yellow-600 hover:bg-yellow-800 focus:ring-yellow-300 dark:focus:ring-yellow-800'
        },
        info: {
            icon: 'text-blue-500 dark:text-blue-400',
            button: 'bg-blue-600 hover:bg-blue-800 focus:ring-blue-300 dark:focus:ring-blue-800'
        }
    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform transition-all scale-100 animate-in zoom-in-95 duration-200">
                <div className="p-6 text-center">
                    <svg className={`w-12 h-12 mx-auto mb-4 ${colors[type].icon}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
