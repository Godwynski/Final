...
export default function SearchFilter() {
    ...
    return (
        <div className="flex flex-col gap-4 mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            ...
            <div className="flex flex-col md:flex-row gap-4 border-t pt-4 dark:border-gray-700">
                <div className="w-full md:w-48">
                    <label htmlFor="incident_type" className="block mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">Incident Type</label>
                    <select
                        id="incident_type"
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="w-full md:w-48">
                    <label htmlFor="start_date" className="block mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">Start Date</label>
                    <input
                        type="date"
                        id="start_date"
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="w-full md:w-48">
                    <label htmlFor="end_date" className="block mb-1 text-xs font-medium text-gray-500 dark:text-gray-400">End Date</label>
                    <input
                        type="date"
                        id="end_date"
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
