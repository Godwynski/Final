    ...
    return (
        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="space-y-6">
                <div>
                    <label htmlFor="narrative_facts" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Facts of the Case</label>
                    ...
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">Describe the sequence of events in detail. You can use the templates above to get started.</p>
                </div>

                <div>
                    <label htmlFor="narrative_action" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Action Taken</label>
                    <textarea
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform transition-all scale-100">
                        <div className="p-6 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apply Template?</h3>
                            <p className="mb-5 text-sm text-gray-500 dark:text-gray-400">This will replace your current text in the "Facts of the Case" section. Are you sure you want to continue?</p>
