        ...
        {parties.length === 0 ? (
          ...
          <div className="space-y-3">
            {parties.map((party) => (
              <div
                key={party.id}
                className="flex items-start p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors group"
              >
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4 ${
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onFocus={() => {
                      if (newParty.name && newParty.name.length >= 2)
                        handleSearch(newParty.name);
                    }}
                  />
                </div>
