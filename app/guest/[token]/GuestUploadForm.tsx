...
export default function GuestUploadForm({ token }: { token: string }) {
        ...
        <form id="upload-form" action={handleSubmit} className="space-y-4">
            <div>
                ...
                <input
                    ...
                    required
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-300">SVG, PNG, JPG or GIF (MAX. 5MB).</p>
            </div>
            <div>
            ...
            >
                {isLoading ? 'Uploading...' : 'Secure Upload'}
            </button>
        </form>
    )
}
